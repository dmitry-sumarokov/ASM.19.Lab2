...
from technic2 import Context
app = Flask(__name__)

if __name__ == '__main__':
    from technic2 import Person_strategy, Person_flask
else:
    from .technic2 import Person_strategy, Person_flask
...
if __name__ == "__main__":
    current_class = Person_strategy(Person_flask)._technic2()
    Menu_list = [
        ['Добавить транспортное средство', current_class.add_person],
        ['Редактировать ', current_class.change_person],
        ['Вывести на экран ', current_class.print_technic2],
